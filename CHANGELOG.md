...
### Fixed
- bumped nltk to 3.10.X to pass uv audit

## [13.1.3] - 2026-05-05

### Fixed
- try to bump pydantic to newer version to solve pydantic and freezegun incosistencies


## [13.1.2] - 2026-04-21

### Fixed
- fix: check release to decide which report (5 vs 5.1) should be used in JsonCounter5SheetReader


## [13.1.1] - 2026-03-06

### Fixed
- max_count from CoordRange crashes the parsing max_count is reached


## [13.1.0] - 2026-02-04

### Added
- uses_items and uses_titles checks added

### Fixed
- infinite loops related fixes
