...
@pytest.mark.parametrize(
    ...
    (
        ...
        ("Thieme", "4/JR1-a.tsv", "nibbler.counter4.JR1", True),
        ("Thieme", "4/JR1-b.tsv", "nibbler.counter4.JR1", False),
        ("Sage", "4/JR1a-a.tsv", "nibbler.counter4.JR1a", True),
        ("Sage", "4/JR1a-b.tsv", "nibbler.counter4.JR1a", False),
        ("OUP", "4/JR1GOA-a.tsv", "nibbler.counter4.JR1GOA", True),
